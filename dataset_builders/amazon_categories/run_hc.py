"""
Run HC Experiments on Amazon Categories Dataset

Tests HC retrieval with global z-score null distribution.
Sweeps gamma and candidate pool size, analyzes by K bucket.
"""
...
def main():
    ...
    print("=" * 70)
    print("HC Experiments (Amazon Categories Dataset)")
    print("=" * 70)
    ...
    # Summary table
    print("\n" + "=" * 70)
    print("SUMMARY - Best configs by F1")
    print("=" * 70)
    print(
        f"{'Config':<25} {'Recall':<8} {'Prec':<8} {'F1':<8} {'MRR':<8} {'NDCG':<8} {'Mean K':<8}"
    )
    print("-" * 73)
    ...
    for config_key, data in sorted_configs:
        ...
        print(
            ...
            f"{r['f1']:<8.4f} {r['mrr']:<8.4f} {r['ndcg']:<8.4f} {r['mean_k']:<8.1f}"
        )
